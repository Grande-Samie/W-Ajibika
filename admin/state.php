...
$_SESSION['msg']="Subcounty added Successfully !!";
...
if(isset($_GET['del']))
          {
                  ...
                  $_SESSION['delmsg']="Subcounty deleted !!";
          }
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Subcounty</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="state.php">Subcounty</a></li>
...
<?php } ?>
                                ...
                                <form method="post" name="Category">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Subcounty Name</label>
                                       <input type="text" placeholder="Enter Subcounty Name"  name="state" class="form-control" required>
