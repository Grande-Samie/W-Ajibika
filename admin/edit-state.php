...
<head>
    <title>CMS||Edit Subcounty</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Edit Subcounty</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="edit-state.php">Edit Subcounty</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Edit Subcounty</h5>
                    </div>
                    <div class="card-body">
                        <h5>View and Edit Subcounty</h5>
                        <hr>
                        <div class="row">
                            <div class="col-md-6">
