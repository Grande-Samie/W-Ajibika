...
?>	
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="announcements.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Add Announcement</span></a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
					    <a href="state.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Add SubCounty</span></a>
					</li>
					<li class="nav-item">
