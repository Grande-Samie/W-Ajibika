                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                <td><b>Latitude</b></td>
                                                                <td colspan="2"><?php echo htmlentities($row['latitude']); ?></td>
                                                                <td><b>Longitude</b></td>
                                                                <td colspan="2"><?php echo htmlentities($row['longitude']); ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td><b>Location Link</b></td>
                                                                <td colspan="5"><a href="https://www.google.com/maps/search/?api=1&query=<?php echo htmlentities($row['latitude']); ?>,<?php echo htmlentities($row['longitude']); ?>" target="_blank">View Location on Map</a></td>
                                                            </tr>
                                                            <tr>
